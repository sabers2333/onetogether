        ...
        <div id="content-core">
            <div id="main">
                <div id="main-core">
                    ...
                    <div class="wpb_row vc_row-fluid row_width1000 have_left_side" style="margin-bottom: 25px;">
                        <div class="vc_span9 wpb_column column_container">
                            <div class="wpb_wrapper">
                                ...
                                <div class="entry-content" style="width:680px;line-height: 24px;">{$info.content}</div>
